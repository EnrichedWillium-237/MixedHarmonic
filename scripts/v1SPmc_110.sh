...
# root -l -b -q '/home/w955m639/v1flow/2015_PbPb/GenerateV1/GenerateV1.C+("v1SPmc_110", "inlist.dat", 50)'
root -l -b -q '/home/w955m639/v1flow/2015_PbPb/GenerateV1/GenerateV1.C+("v1SPmc_110", "inlist.dat", 5000)' > logs/v1SPmc_110.logs
cd ..
